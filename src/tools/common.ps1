...
$jsPrefix = Get-Prefix
# Extract the version number from the file in the package's content\scripts\bitsetjs folder
$packageScriptsFolder = Join-Path $installPath Content\Scripts\BitSetJs
